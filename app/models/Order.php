...
class Order extends AppModel
{
    ...
    public static function mailOrder($order_id, $user_email)
    {
        ...
        $message_client = (new Swift_Message("Вы оформили заказ №{$order_id} на сайте " . App::$app->getProperty('shop_name')))
        ...
        $_SESSION['success'] = 'Спасибо за ваш заказ. В ближайшее время с ваши свяжутся менеджер для согласования заказа';
    }
}