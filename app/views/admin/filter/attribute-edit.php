...
<section class="content-header">
    <h1>
        Редктирвоание фильтр <?=h($attr->value);?>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?=ADMIN;?>"><i class="fa fa-dashboard"></i> Главная</a></li>
        <li><a href="<?=ADMIN;?>/filter/attribute">Список фильтров</a></li>
        <li class="active">Редктирвоание</li>
    </ol>
</section>
                    ...
                    <div class="box-body">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="value" class="form-control" id="value"
                                   placeholder="Наименование" value="<?=h($attr->value);?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <select name="attr_group_id" id="category_id" class="form-control">
                                <?php foreach($attrs_group as $item): ?>
                                    <option value="<?=$item->id;?>" <?php if($item->id == $attr->attr_group_id)
                                        echo ' selected'; ?> >
                                        <?=$item->title;?>
                                    </option>
                                <?php endforeach; ?>
